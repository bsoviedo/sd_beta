        ...
        <Container className="px-4 px-lg-5 pb-5">
          <Card className="sd-card border-0">
            <Card.Body className="py-5 px-4 px-lg-5" style={{ fontSize: "15px", lineHeight: "1.7" }}>
              ...
              <p><strong>PLEASE READ THESE TERMS CAREFULLY AS THEY ESTABLISH A LEGAL AGREEMENT BETWEEN YOU AND SUSTAINABLE DISCOUNTS™, A SUBSIDIARY OF ESTRATRA LLC.</strong></p>
              <p>Please Note: Section 8 of these Terms of Service contains the link to the Term&apos;s <strong>DISPUTE RESOLUTION, ARBITRATION CLAUSE and CLASS ACTION WAIVER</strong> that applies to all  Sustainable Discounts™ Users. It affects and dictates how disputes with  Sustainable Discounts™ are resolved. By accepting these Terms of Service, <u>you agree to be bound by this Arbitration Clause and Class Action Waiver</u>.</p>
              <p><em>Please review these Terms of Service periodically, as they are subject to alterations by and at the sole discretion of Sustainable Discounts™ at anytime for any reason. So long as you continue to use  Sustainable Discounts™, any such modifications will <strong>AUTOMATICALLY</strong> apply to you.</em></p>
              ...
              <p style={{ marginLeft: "1.2rem" }}>
                ...
                1.2. These Terms govern the access and use of the Services provided through  Sustainable Discounts™ by Estratra LLC within the entire United States, its territories, and possessions.<br />
                1.3. By accessing or using  Sustainable Discounts™, you agree to be bound by all of these Terms.<br />
              ...
              <p style={{ marginLeft: "1.2rem" }}>
                ...
                2.4. You will in no way upload or use viruses including &quot;bugs,&quot; &quot;spiders,&quot; &quot;robots,&quot; or any other virulent code, or any other means of altering  Sustainable Discounts™&apos;s Technological Dignity.<br />
                2.5. By agreeing to these Terms, you agree to in no way use  Sustainable Discounts™ for illegal or mischievous purposes.
              </p>

              <h5 className="mt-4 mb-2" style={{ color: "var(--sd-primary)" }}>3. Payment</h5>
              <p style={{ marginLeft: "1.2rem" }}>
                3.1. You are fully aware that by purchasing a product or by selecting a product to save through  Sustainable Discounts™ Services, you as the User, are fully and solely responsible for all charges that apply to the product(s), including all taxes.<br />
              ...
              <p style={{ marginLeft: "1.2rem", fontWeight: "bold" }}>
                4.1. YOU ACKNOWLEDGE THAT YOUR USE OF SUSTAINABLE DISCOUNTS™ IS AT YOUR OWN RISK.<br />
              ...
              <p style={{ marginLeft: "1.2rem" }}>
                5.1. You acknowledge that in <strong>NO EVENT</strong>, shall  Sustainable Discounts™, Estratra, its Owners, Directors, Employees or Agents, be liable to you for any Damages whether they be Direct, Indirect, Incidental, Special, Punitive, or Consequential; as the result of Personal Injury, Property Damage, or any losses of any kind including monetary losses.
              </p>
              ...
              <p style={{ marginLeft: "1.2rem" }}>
                ...
                6.2. This Indemnification obligation survives these Terms as well as your usage of  Sustainable Discounts™ and the services it provides.
              </p>
              ...
              <p style={{ marginLeft: "1.2rem", fontWeight: "bold" }}>
                This is a Dispute Resolution Agreement that you MUST read carefully. It is part of the Terms of the Contract you are making with  Sustainable Discounts™ and affects your rights. It contains procedures for MANDATORY BINDING ARBITRATION AND A CLASS ACTION WAIVER.
              </p>
              ...
              <p style={{ marginLeft: "1.2rem" }}>
                <em>Account</em> — The portal through which Users access the Services of  Sustainable Discounts™.<br />
                <em>Acceptance</em> — Fully downloading and any use of  Sustainable Discounts™ is an acceptance of all of these Terms.<br />
                <em>Amendments</em> — Any modifications made to these Terms, solely at the discretion of  Sustainable Discounts™.<br />
                <em>Employee</em> — Any individual working for, and directly under the control of  Sustainable Discounts™ management.<br />
                <em>Services</em> — All of the accommodations  Sustainable Discounts™ offers to consumers.<br />
                <em>Terms</em> — Every Condition and Policy listed in this entire document.<br />
                <em>User</em> — Anyone utilizing the Services of  Sustainable Discounts™.
              </p>

              <h5 className="mt-4 mb-2" style={{ color: "var(--sd-primary)" }}>Customer Service</h5>
              <p style={{ marginLeft: "1.2rem" }}>
                For any questions or concerns regarding these terms or any aspects of  Sustainable Discounts™, please contact us at{" "}
