          ...
          <Row className="align-items-center g-5 mb-4">
            <Col lg={6}>
              <div className="sd-blog-content">
                <p className="sd-blog-text mb-3" style={{ fontSize: "1.1rem", lineHeight: "1.7", color: "var(--sd-dark)" }}>
                  {t("conservation.problemSection.body1")}
                </p>
                <p className="sd-blog-text mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.6" }}>{t("conservation.problemSection.body2")}</p>
                <p className="sd-blog-text fw-bold mb-0" style={{ color: "var(--sd-primary)", fontSize: "1.1rem" }}>
            ...
            <Col lg={6}>
              <div className="d-flex flex-column gap-3">
                <article className="sd-team-card p-4" style={{ borderRadius: "16px", background: "#ffffff", boxShadow: "0 10px 24px rgba(35,59,45,0.04)" }}>
                  <h3 className="fs-5 fw-bold mb-2" style={{ color: "var(--sd-primary)" }}>{t("conservation.problemSection.gapTitle")}</h3>
                  <p className="small text-muted mb-0" style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>{t("conservation.problemSection.gap")}</p>
                </article>
                <article className="sd-team-card p-4" style={{ borderRadius: "16px", background: "#ffffff", boxShadow: "0 10px 24px rgba(35,59,45,0.04)" }}>
                  <h3 className="fs-5 fw-bold mb-2" style={{ color: "var(--sd-primary)" }}>{t("conservation.problemSection.strainTitle")}</h3>
                  <p className="small text-muted mb-0" style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>{t("conservation.problemSection.strain")}</p>
                </article>
                <article className="sd-team-card p-4" style={{ borderRadius: "16px", background: "#ffffff", boxShadow: "0 10px 24px rgba(35,59,45,0.04)" }}>
                  <h3 className="fs-5 fw-bold mb-2" style={{ color: "var(--sd-primary)" }}>{t("conservation.problemSection.solutionTitle")}</h3>
                  <p className="small text-muted mb-0" style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>{t("conservation.problemSection.solution")}</p>
                </article>
              </div>
            </Col>
          </Row>
        ...
        <Container className="px-4 px-lg-5">
          ...
          <Row className="align-items-center g-5">
            <Col lg={6} className="order-lg-2">
              <div className="sd-blog-content">
                <div className="sd-blog-highlight mb-4 p-4" style={{ borderRadius: "12px", background: "rgba(31, 138, 76, 0.06)" }}>
                  <p className="sd-blog-text mb-0 fw-semibold" style={{ fontSize: "1.05rem" }}>{t("conservation.offerSection.highlight")}</p>
                </div>
                <p className="sd-blog-text mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.6" }}>{t("conservation.offerSection.subtitle")}</p>
            ...
            <Col lg={6} className="order-lg-1">
              <div className="d-flex flex-column gap-3">
                <div className="sd-blog-metric p-3 text-center m-0" style={{ background: "white", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", borderRadius: "10px" }}>{t("conservation.offerSection.metric1")}</div>
                <div className="sd-blog-metric p-3 text-center m-0" style={{ background: "white", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", borderRadius: "10px" }}>{t("conservation.offerSection.metric2")}</div>
                <div className="sd-blog-metric p-3 text-center m-0" style={{ background: "white", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", borderRadius: "10px" }}>{t("conservation.offerSection.metric3")}</div>
              </div>
            </Col>
          </Row>
        </Container>
      ...
      <section className="sd-section sd-blog-section pt-0">
        <Container className="px-4 px-lg-5">
          ...
          <Row className="align-items-center g-5">
            <Col lg={6}>
              <div className="sd-blog-content">
                <p className="sd-blog-text mb-4" style={{ fontSize: "1.1rem" }}>{t("conservation.industrySection.intro")}</p>
                <div className="d-flex flex-wrap gap-2 mb-2">
                  <div className="sd-blog-metric px-3 py-2 m-0" style={{ background: "white", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", borderRadius: "8px", fontSize: "0.95rem" }}>{t("conservation.industrySection.ind1")}</div>
                  <div className="sd-blog-metric px-3 py-2 m-0" style={{ background: "white", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", borderRadius: "8px", fontSize: "0.95rem" }}>{t("conservation.industrySection.ind2")}</div>
                  <div className="sd-blog-metric px-3 py-2 m-0" style={{ background: "white", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", borderRadius: "8px", fontSize: "0.95rem" }}>{t("conservation.industrySection.ind3")}</div>
                  <div className="sd-blog-metric px-3 py-2 m-0" style={{ background: "white", boxShadow: "0 4px 15px rgba(0,0,0,0.03)", borderRadius: "8px", fontSize: "0.95rem" }}>{t("conservation.industrySection.ind4")}</div>
                </div>
              </div>
            </Col>
            <Col lg={6}>
              <div className="sd-blog-content">
                <p className="sd-blog-text text-muted mb-3" style={{ fontSize: "0.95rem" }}>
      ...
      <section className="sd-section sd-blog-section pt-0">
        <Container className="px-4 px-lg-5">
          ...
          <Row className="align-items-center g-5">
            <Col lg={7}>
              <div className="sd-blog-content">
                <p className="sd-blog-text mb-3" style={{ fontSize: "1.05rem" }}>{t("conservation.projectSection.intro")}</p>
                <p className="sd-blog-text mb-4" style={{ fontSize: "1rem", lineHeight: "1.6" }}>
                  {t("conservation.projectSection.body")}
                </p>
                <p className="sd-blog-text mb-0 text-muted fw-semibold" style={{ fontSize: "0.95rem", color: "var(--sd-primary)" }}>
            ...
            <Col lg={5}>
              <div className="d-flex flex-column gap-3">
                <div className="sd-blog-highlight p-4 m-0" style={{ borderRadius: "12px", background: "rgba(31, 138, 76, 0.06)" }}>
                  <p className="sd-blog-text mb-0 fw-semibold" style={{ fontSize: "1rem", lineHeight: "1.5" }}>{t("conservation.projectSection.highlight")}</p>
                </div>
